...
:experimental:
:url-github: https://github.com/hyperpolymath/claude-gitlab-bridge
:url-gitlab: https://gitlab.com/hyperpolymath/claude-gitlab-bridge
:url-bitbucket: https://bitbucket.org/hyperpolymath/claude-gitlab-bridge
:url-codeberg: https://codeberg.org/hyperpolymath/claude-gitlab-bridge

Claude AI to GitLab integration and automation bridge
...
claude-gitlab-bridge is part of the link:https://rhodium.sh[Rhodium Standard] (RSR) ecosystem.
